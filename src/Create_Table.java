...
public class Create_Table {
	public static void CreateTable(String SchemaName, String TableName, ArrayList<String> columnNames, ArrayList<String> columnTypes, ArrayList<String> columnNulable, ArrayList<String> columnKey){
		...
		if(checkTableExistance(TableName, SchemaName))
		...
		for(int i=0; i<columnnumber; i++){
			...
			String Key="";
			if(columnNulable.get(i).toLowerCase().equals("not null"))
			IsNulable = "NO";
			if(columnKey.get(i).toLowerCase().equals("primary key"))
			{Key="PRI";
			IsNulable = "NO";}
	...
	public static boolean checkTableExistance(String tableName, String schemaName){
		boolean found=false;
